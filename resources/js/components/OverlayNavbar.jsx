  ...
  return (
    ...
    <div>
        ...
        <div className={`${!isMenuOpened && 'hidden'} w-full md:flex md:items-center md:w-auto`}>
            <ul className="pt-4 text-base text-violet-500 md:flex md:justify-between md:pt-0 items-center">
                {
                    auth ?
                    <>
                        {
                            hasPlus ?
                            <li><Link href="/plus" className="m-1 text-sm md:p-2 py-2 block border-2 border-green-300 rounded-lg hover:bg-green-400 bg-green-500 text-white">پلاس فعال</Link></li>
                            :
                            <li><Link href="/plus" className="m-1 text-sm md:p-2 py-2 block border-2 border-red-300 rounded-lg hover:bg-red-400 bg-red-500 text-white">پلاس غیرفعال</Link></li>
                        }
                        <li><Topics /></li>
